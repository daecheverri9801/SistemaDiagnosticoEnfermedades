...
const crearMedico = async ( medico ) => {
    const { nombre, especialidad, registro_medico, correo_electronico, idauth } = medico
    const result = await db.query(
        `INSERT INTO Medico (nombre, especialidad, registro_medico, correo_electronico, idauth)
         VALUES ($1, $2, $3, $4, $5) RETURNING *`,
        [nombre, especialidad, registro_medico, correo_electronico, idauth]
    )
